using Filipas_Denisa_Lab2.Models;
using Microsoft.EntityFrameworkCore;
using System.Reflection;
using System.Xml.Linq;

namespace Filipas_Denisa_Lab2.Data
{
                              ...
                              <DbContextOptions<LibraryContext>>()))
            {
                ...
                //context.Authors.AddRange(
                   // new Author { ID = 1, FirstName = "Mihail", LastName = "Sadoveanu" },
                    //new Author { ID = 2, FirstName = "Ion", LastName = "Creanga" }
                   // );
               ...
               //context.SaveChanges();
                ...
                context.Customers.AddRange(
                    ...
                    new Customer{ Name = "Mihailescu Cornel",Adress = "Str. Bucuresti, nr. 45", BirthDate = DateTime.Parse("1969-07-08")}
                );
                context.SaveChanges();
            }
        }
